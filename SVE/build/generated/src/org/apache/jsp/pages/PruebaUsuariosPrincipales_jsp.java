...
public final class PruebaUsuariosPrincipales_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                $(\"#btnModificar\").attr(\"disabled\",\"disabled\");\n");
      ...
      out.write("                            var cnr = $(\"td[data-rol=3]\").length;\n");
      out.write("                            var tse = $(\"td[data-rol=6]\").length;\n");
      out.write("                            //impresion de cuenta de usuarios\n");
      ...
      out.write("                            //limpieza del formulario\n");
      out.write("                            $(\"#frmUsuarios\")[0].reset();\n");
      ...
      out.write("                //ya que hay una candidad establecida de usuarios a registrar, no se puede modificar el tipo de usuario\n");
      ...
      out.write("                            var cnr = $(\"td[data-rol=3]\").length;\n");
      out.write("                            var tse = $(\"td[data-rol=6]\").length;\n");
      out.write("                            //impresion de la cuenta de usuarios\n");
      out.write("                            $(\"#divRegistros\").html(\"Magistrados: \" + magistrados + \"<br>\");\n");
      out.write("                            $(\"#divRegistros\").append(\"CNR: \" + cnr + \"<br>\");\n");
      out.write("                            $(\"#divRegistros\").append(\"TSE: \" + tse);\n");
      out.write("                            //desactivacion y activacion de campos\n");
      out.write("                            $(\"#slTipoUsuario\").prop('disabled',false);\n");
      out.write("                            $(\"#btnModificar\").prop('disabled','disabled');\n");
      out.write("                            $(\"#btnAgregar\").prop('disabled',false);\n");
      out.write("                            $(\"#frmUsuarios\")[0].reset();\n");
      out.write("                            $(\"#divUsuario\").html('<input type=\"hidden\" value=\"0\" id=\"txtResultado\">');\n");
      out.write("                        });\n");
      out.write("\n");
      ...
      out.write("                //deshabilitamos el combo de tipo de usuario, para evitar que cambie ese campo\n");
      out.write("                $(\"#slTipoUsuario\").prop('disabled','disabled');\n");
