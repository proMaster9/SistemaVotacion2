                ...
                <div class="body" >
                    <form id="sign_in" method="POST" action="../../../iniciar_sesion">                 
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control" name="txtUser" placeholder="Ingrese su nombre usuario" required autofocus>
                            </div>
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <button class="btn btn-block bg-light-blue waves-effect" type="submit" name="btnEntrarA">Entrar</button>
                                <button type="button" class="btn btn2 bg-cyan waves-effect m-r-0 waves-light" data-toggle="modal" data-target="#datosIncorrectos" >MODIFICAR</button>
                            </div>
                        </div>
