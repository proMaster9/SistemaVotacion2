<%-- 
    Document   : tse_usuario_principal
    Created on : 09-oct-2016, 17:26:43
    Author     : JH
--%>
<%
    ...
    <body class="login-page">
        <div class="login-box">
            <div class="card">
                ...
                <div class="body" >
                    <form id="sign_in" method="POST" action="../../sesion_principal">                 
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <button class="btn btn-block bg-light-blue waves-effect" type="submit" name="entrarPrincipal">Entrar</button>
                            </div>
                        </div>
