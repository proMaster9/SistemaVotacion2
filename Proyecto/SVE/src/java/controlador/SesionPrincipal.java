 ...
 * @author Icchigo
 */
public class SesionPrincipal extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet SesionPrincipal</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet SesionPrincipal at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
//    }
                ...
                if (!user.equals("") && !pass.equals("")) {
                    ...
                    if(c.getConfirmacion() == 0 ){
                        if (user.equals(c.getNumDui()) && pass.equals(c.getContrasenia())){
                            ...
                            sesion.setAttribute("key", "2");
                            response.sendRedirect("pages/tse.jsp");
                        } else {
                            //datos incorrectos
                            response.sendRedirect("pages/login/tse_principal.jsp");
                        }
                    }else{
