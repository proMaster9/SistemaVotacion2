                            ...
                            <form id="frmCentroVotacion">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-9 col-xs-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="txtNombre" class="form-control" name="txtNombre" placeholder="Ingresar nombre Centro Votación">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-9 col-xs-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="txtDireccion" class="form-control" name="txtDireccion" placeholder="Ingresar dirección Centro Votación">
                                            </div>
                                        </div>
                                    </div>
                                </div>
