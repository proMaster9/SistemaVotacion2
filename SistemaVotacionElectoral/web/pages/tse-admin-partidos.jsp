<%-- 
    Document   : tse-admin-partidos
    Created on : 10-05-2016, 07:43:35 PM
    Author     : sam23
--%>
<%-- 
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-light-blue">
                            <h2><i class="material-icons icons-align">add</i>Partidos
                        ...
                        <div class="body table-responsive">
                           <form action="" method="post" class="">
                                <button type="button" class="btn bg-light-blue waves-effect">Nuevo Partido <i class="material-icons col-green icons-align" >person_add</i></button>
                            ...
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                        <li role="presentation"><a href="#registrar_magistrado" data-toggle="tab">Partido</a></li>
                                        ...
                                        <div role="tabpanel" class="tab-pane animated zoomIn active" id="registrar_magistrado">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="demo-google-material-icon">
                                                    <i class="material-icons col-green icons-align">group_add</i>
                                                    <span>Representante de Partido </span>
                                                </div>
                                                 ...
                                                 <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-sm-9 col-xs-6">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input type="text" class="form-control" name="" placeholder="Dui">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
